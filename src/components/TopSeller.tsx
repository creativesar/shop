...
const products: Product[] = [
  {
    id: 1,
    name: 'Vertical Stripee Shirt',
    href: '#',
    imageSrc: '/top-1.png',
    imageAlt: 'Front of Vertical Stripee Shirt.',
    price: '$212',
    oldPrice: '$232',
    discount: '20%',
    rating: 4.5,
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/top-2.png',
    imageAlt: 'Front of Courage Graphic T-Shirt.',
    price: '$145',
    rating: 4.8,
    reviews: 290,
  },
  {
    ...
    href: '#',
    imageSrc: '/top-3.png',
    imageAlt: 'Front of Loose Fit Bermuda Shorts.',
    price: '$80',
    rating: 4.4,
    reviews: 145,
  },
  {
    ...
    href: '#',
    imageSrc: '/top-4.png',
    imageAlt: 'Front of Faded Skinny Jeans.',
    price: '$210',
    rating: 4.2,
    reviews: 312,
  },
